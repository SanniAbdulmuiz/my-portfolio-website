...
export const metadata = {
  title: 'My Tech Stack | Abdulmuiz Ayomide | Frontend Developer',
  description:
    'Explore the frontend technologies and tools Abdulmuiz Ayomide uses — including React, Next.js, TypeScript, Tailwind CSS, and more to build modern, scalable web experiences.',
  keywords: [
    'Frontend Developer',
    'React',
    'Next.js',
  ...
  openGraph: {
    title: 'My Tech Stack | Abdulmuiz Ayomide',
    description:
      'Technologies I use to build responsive, high-performance web applications — from React and Next.js to Tailwind CSS and TypeScript.',
    url: 'https://my-portfolio-website-zeta-eosin.vercel.app/stack',
  ...
  twitter: {
    ...
    title: 'My Tech Stack | Abdulmuiz Ayomide',
    description:
      'Explore the frontend technologies powering my projects — React, Next.js, TypeScript, and Tailwind CSS.',
...
function MyStack() {
  return (
    <section
      id='stack'
      aria-label='Frontend technologies and tools used by Abdulmuiz Ayomide'
      className='max-w-6xl mx-auto px-4 py-12'
    >
      <h2 className='text-4xl font-bold text-center mb-12 text-blue-100'>My Stack</h2>
